                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">ID Utilisateur</th>
                                    <th scope="col" class="px-4 py-3">ID Annonce</th>
                            ...
                            <tbody>';
                                ...
                                if (gettype($context["commentData"]) == "object") {
                                    $html .= '
                                        <tr class="border-b dark:border-gray-700">
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">' . $context["commentData"]->idAvis . '</th>
                                        <td class="px-4 py-3">' . $context["commentData"]->idUtilisateur . '</td>
                                        <td class="px-4 py-3">' . $context["commentData"]->idAnnonce . '</td>
                                        <td class="px-4 py-3">' . $context["commentData"]->Note . '</td>
                                        <td class="px-4 py-3">' . $context["commentData"]->Commentaires . '</td>
                                        <td class="px-4 py-3">
                                            <form action="/delete-comment" method="post">
                                                <input type="text" name="idAvis" class="hidden" value=' . $context["commentData"]->idAvis . '>
                                    ...
                                    for ($i = 0; $i < count($context["commentData"]); $i++) { 
                                        $html .= '
                                            <tr class="border-b dark:border-gray-700">
                                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">' . $context["commentData"][$i]->idAvis . '</th>
                                            <td class="px-4 py-3">' . $context["commentData"][$i]->idUtilisateur . '</td>
                                            <td class="px-4 py-3">' . $context["commentData"][$i]->idAnnonce . '</td>
                                            <td class="px-4 py-3">' . $context["commentData"][$i]->Note . '</td>
                                            <td class="px-4 py-3">' . $context["commentData"][$i]->Commentaires . '</td>
                                            <td class="px-4 py-3">
                                                <form action="/delete-comment" method="post">
                                                    <input type="text" name="idAvis" class="hidden" value=' . $context["commentData"][$i]->idAvis . '>
                                                    <input type="submit" value="Supprimer" class="text-red-600 font-bold cursor-pointer"  />
                                                </form>
                                            </td>
                                            </tr>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div class="flex justify-center items-center space-x-4">
                        ...
                        <button type="submit" class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">Yes, Im sure</button>
                    </div>
                </div>
            </div>
        </div>
