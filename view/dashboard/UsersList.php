                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>';
                                ...
                                if (gettype($context["usersData"]) == "object") {
                                    $html .= '
                                        <tr class="border-b dark:border-gray-700">
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">' . $context["usersData"]->idUtilisateur . '</th>
                                        <td class="px-4 py-3">' . $context["usersData"]->email . '</td>
                                        <td class="px-4 py-3">' . $context["usersData"]->prenom . ' '. $context["usersData"]->nom . '</td>';
                                        if ($context["usersData"]->admin) {
                                            $html .= '<td class="px-4 py-3 font-bold max-w-[12rem] text-green-400 truncate">✓</td>';
                                        }  
                                        else {
                                            $html .= '<td class="px-4 py-3 font-bold max-w-[12rem] text-red-400 truncate">X</td>';
                                        }
                                        $html .='
                                        <td class="px-4 py-3">
                                            <form action="/delete-user" method="post">
                                                <input type="text" name="userId" class="hidden" value=' . $context["usersData"]->idUtilisateur . '>
                                    ...
                                    for ($i = 0; $i < count($context["usersData"]); $i++) { 
                                        $html .= '
                                            <tr class="border-b dark:border-gray-700">
                                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">' . $context["usersData"][$i]->idUtilisateur . '</th>
                                            <td class="px-4 py-3">' . $context["usersData"][$i]->email . '</td>
                                            <td class="px-4 py-3">' . $context["usersData"][$i]->prenom . ' '. $context["usersData"][$i]->nom . '</td>';
                                            if ($context["usersData"][$i]->admin) {
                                                $html .= '<td class="px-4 py-3 font-bold max-w-[12rem] text-green-400 truncate">✓</td>';
                                            }  
                                            else {
                                                $html .= '<td class="px-4 py-3 font-bold max-w-[12rem] text-red-400 truncate">X</td>';
                                            ...
                                            <td class="px-4 py-3">
                                                <form action="/delete-user" method="post">
                                                    <input type="text" name="userId" class="hidden" value=' . $context["usersData"][$i]->idUtilisateur . '>
                                                    <input type="submit" value="Supprimer" class="text-red-600 font-bold cursor-pointer"  />
                                                </form>
                                            </td>
                                            </tr>
