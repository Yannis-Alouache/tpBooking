...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 12 jan. 2024 à 13:30
...
INSERT INTO `annonce` (`idAnnonce`, `idUtilisateur`, `disponibilite_debut`, `disponibilite_fin`, `emplacement`, `prix`, `description`, `animaux`, `enfants`, `accessibilite`) VALUES
(1, 1, '2024-01-19', '2024-04-12', 'Gare Lille Flandres', 84, 'Appartement 60m², vue sur la gare de lille, proche des transports en communs et peu de bruits la nuit.', 1, 1, 0);
...
(1, 'Dupont', 'Antoine', '15 rue du Général de Gaulles', 21, 59000, 'Lille', '0659478456', 1, 1, 0, '91e46e5596056690f171cbc6d70dbe380750a711000bb3a29af74c04f6fa4e33', 'dupont.antoine@gmail.com'),
(2, 'Dubois', 'Marc', '3 avenue François Mitterrand', 25, 59000, 'Lille', '0678491258', 1, 1, 1, '4e5143344ef8514897063936ef05b2c502878d5a9068685b90c4df376ce3ca60', 'dubois.marc@hotmail.fr');
