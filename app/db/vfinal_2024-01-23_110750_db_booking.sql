...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 23 jan. 2024 à 07:52
...
(11, 1, '0000-00-00', '0000-00-00', 'dlsjkldg', 1, 'dsjflkdsj', 0, 0, 0, ''),
(12, 1, '0000-00-00', '0000-00-00', 'dlsjkldg', 1, 'dsjflkdsj', 0, 0, 0, '');
...
(2, 2, 3, 4, 'Magnifique :D', '2024-01-15 14:11:42'),
(7, 1, 1, 5, 'Incroyable', '2024-01-23 08:41:07');
...
CREATE TABLE IF NOT EXISTS `regles` (
  `idRegles` int NOT NULL AUTO_INCREMENT,
  `idAnnonce` int NOT NULL,
